  ...
  return (
    <section aria-label="Get a quote" className="py-16 sm:py-20 lg:py-24">
      <div className="mx-auto max-w-content px-6 lg:px-8">
        <div className="flex flex-col items-center gap-6 rounded-2xl bg-sky-gradient p-7 sm:p-8 lg:flex-row lg:justify-between lg:p-7">
          <h2 className="max-w-6xl text-center text-2xl font-medium text-white sm:text-3xl lg:text-left lg:text-5xl">
